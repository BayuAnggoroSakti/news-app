package itts.bayu.newsapp.fragment
...
import itts.bayu.newsapp.adapter.NewsAdapter
import itts.bayu.newsapp.model.ModelArticle
import itts.bayu.newsapp.model.ModelNews
import itts.bayu.newsapp.networking.ApiEndpoint.getApiClient
import itts.bayu.newsapp.networking.ApiInterface
import itts.bayu.newsapp.util.Utils.getCountry
...
class FragmentBusiness : Fragment() {
    ...
    companion object {
        const val API_KEY = "c33d1139cbb74fea85f21f248e28bdd4"
    }

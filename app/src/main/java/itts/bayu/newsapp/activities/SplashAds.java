...
public class SplashAds extends AppCompatActivity {
    private static final String TAG = SplashAds.class.getSimpleName();
    ...
    private SplashView.SplashAdLoadListener splashAdLoadListener = new SplashView.SplashAdLoadListener() {
        ...
        public void onAdLoaded() {
            ...
            //Toast.makeText(SplashAds.this, getString(R.string.status_load_ad_success), Toast.LENGTH_SHORT).show();
        }
        ...
        public void onAdFailedToLoad(int errorCode) {
            ...
            Toast.makeText(SplashAds.this, getString(R.string.status_load_ad_fail) + errorCode, Toast.LENGTH_SHORT).show();
            jump();
        }
        ...
        public void onAdDismissed() {
            ...
            //Toast.makeText(SplashAds.this, getString(R.string.status_ad_dismissed), Toast.LENGTH_SHORT).show();
            jump();
        }
    };
    ...
    private void jump() {
        ...
        if (!hasPaused) {
            ...
            startActivity(new Intent(SplashAds.this, MainActivity.class));
